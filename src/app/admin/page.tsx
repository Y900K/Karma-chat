...
const queue = [
  ...
  {
    type: "Drive PDF",
    title: "Electrical symbols worksheet · हिंदी",
    owner: "Neha Joshi",
  ...
  {
    type: "Question",
    title: "Overload relay scenario Q-148",
...
const partners = [
  ...
  {
    name: "Apex Fabrication Works",
    type: "Employer",
    status: "Site check required",
    risk: "Review",
  },
];
export default function Admin() {
  ...
  const c =
    lang === "en"
      ? {
          title: "Keep every learning and hiring signal trustworthy.",
          sub: "One operational view for content, partners, AI releases and platform safety.",
          queue: "Content review queue",
          partners: "Partner verification",
        }
      : {
          title: "हर learning और hiring signal को भरोसेमंद रखें।",
          sub: "Content, partners, AI releases और platform safety के लिए एक operational view।",
          queue: "Content review queue",
          partners: "Partner verification",
        };
  return (
    <main className="adm-shell pilot-live">
      ...
      <section className="adm-main">
        ...
        <div className="adm-content" id="admin-overview">
          ...
          <LiveDashboardStatus scope="admin" />
          <div className="ops-alert">
            <ShieldCheck />
            <p>
              <b>Publishing gates are active</b>
              <span>
                No content, prompt, question or partner becomes visible without
                the required review chain and audit record.
              </span>
            </p>
            <button>
          ...
          <div className="adm-grid">
            <article className="content-queue" id="admin-content">
              ...
              {queue.map((x) => (
                <div className="qrow" key={x.title}>
                  <span>
                    <i>
                      {x.type === "YouTube" ? (
                        <Film />
              ...
              <div className="embed-rule">
                <Link2 />
                <p>
                  <b>Embed registry rule</b>
                  <span>
                    YouTube uses privacy-enhanced playback; Drive files require
                    allowlisted ownership, view-only permissions, review dates
                    and a text fallback.
                  </span>
                </p>
              </div>
            </article>
            <article className="source-health">
              <div className="ahead">
                <div>
                  <p>EMBED RELIABILITY</p>
                  <h2>External source health</h2>
                </div>
                <span className="ok">
                  <CheckCircle2 />
                  Healthy
              ...
              {[
                ["YouTube lessons", "42", "100% reachable"],
                ["Google Drive resources", "31", "2 reviews due"],
                ["Caption coverage", "89%", "5 gaps"],
                ["Text fallbacks", "100%", "All resources"],
              ].map(([a, b, d]) => (
                <div className="source" key={a}>
                  <p>
                    <b>{a}</b>
                    <span>{d}</span>
                  </p>
            ...
            <article className="partners" id="admin-partners">
              ...
              {partners.map((x) => (
                <div className="partner" key={x.name}>
                  <i>
                    <Building2 />
                  </i>
                  <p>
                  ...
                  <em className={x.risk === "Low" ? "low" : ""}>{x.risk}</em>
                  <button>
                    Review
                    <ArrowRight />
                  </button>
            ...
            <article className="aiops" id="admin-ai">
              <div className="ahead">
                <div>
                  ...
                  <h2>Prompts, models & evaluations</h2>
                </div>
                <Bot />
              </div>
              <div className="release">
                <p>
                  ...
                  <b>Career coach · v0.7.3</b>
                  <small>
                    NVIDIA gateway · Structured output · Released 18 Aug
                  </small>
                </p>
                <em>Healthy</em>
              </div>
              ...
              <div className="pending">
                <AlertTriangle />
                <p>
                  <b>One release awaiting human approval</b>
                  <span>Interview feedback v0.6.0 passed automated evals.</span>
                </p>
            ...
            <article className="flags" id="admin-flags">
              ...
              {[
                ["voice_interview_pilot", "10% · Dehradun pilot", true],
                ["drive_inline_preview", "Staff only", true],
                [
                  "employer_direct_message",
                  "Disabled pending safety review",
                  false,
                ],
              ].map(([name, scope, on]) => (
                <div className="flag" key={String(name)}>
                  <p>
                    <b>{String(name)}</b>
                    <span>{String(scope)}</span>
                  </p>
                  <ToggleRight className={on ? "on" : ""} />
                </div>
              ))}
            </article>
            <article className="health" id="admin-health">
              ...
              <button className="runbook">
                <ClipboardCheck />
                Open incidents, logs and runbooks
                <ArrowRight />
              </button>
            </article>
          </div>
